...
import '../controllers/add_past_question_controller.dart';
import '../models/past_question.dart';

class AddPastQuestionView extends HookWidget {
            ...
            children: [
              ...
              Consumer(
                builder: (_, watch, __) => AppElevatedButton(
                  ...
                  isLoading: watch(addPastQuestionControllerProvider).state ==
                      AppState.loading,
                  onPressed: () async {
                    FocusScope.of(context).unfocus();
                    ...
                    if (_formKey.currentState!.validate()) {
                      await context
                          .read(addPastQuestionControllerProvider)
                          .addCourse(
                            PastQuestionParams(
